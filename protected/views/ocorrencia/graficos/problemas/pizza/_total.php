...
$this->Widget('ext.highcharts.HighchartsWidget', array(
    'options' => array(
        ...
        'title' => array(
        'text' => Yii::t('main','dashboard.ocorrencias.tipoServicoTotal').'<br><br>'.$model->DataOcorrencia
        ),
        'tooltip' => array(
        ...
        'plotOptions' => array(
            'pie' => array(
                ...
                'events' => array(
                    ...
                    . 'gerarRelatorio(chave, relatorioProblemaTotal);'
                    . '$("#modal").modal(\'show\'); }',
                ),
            ),
        ),
        'series' => array(
            array(
                ...
                'name' => 'Quantidade ',
                'data' => $model->graficoPorTipo('dsProblema','total'),
            ),
        ),
      ),
...
<?php
    $dados = $model->graficoPorTipo('dsProblema','relatorioTotal');
    $dados = json_encode( $dados );
?>

<script type="text/javascript">
    var relatorioProblemaTotal = <?php echo $dados ?>;
</script>