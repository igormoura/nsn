...
$this->Widget('ext.highcharts.HighchartsWidget', array(
    'options' => array(
        ...
        'title' => array(
        'text' => Yii::t('main','dashboard.ocorrencias.tipoServicoMenor72').'<br><br>'.$model->DataOcorrencia
        ),
        'tooltip' => array(
        ...
        'pie' => array(
            ...
            'events' => array(
                ...
                . 'gerarRelatorio(chave, relatorioProblemaMenor72);'
                . '$("#modal").modal(\'show\'); }',
            ),
        )
        ),
        'series' => array(
            array(
                ...
                'name' => 'Quantidade ',
                'data' => $model->graficoPorTipo('dsProblema','menor'),
            ),
        ),
      ),
...
<?php
    $dados = $model->graficoPorTipo('dsProblema','relatorioMenor72');
    $dados = json_encode( $dados );
?>

<script type="text/javascript">
    var relatorioProblemaMenor72 = <?php echo $dados ?>;
</script>