    ...
    'options' => array(
        ...
        'pie' => array(
            ...
            'events' => array(
                ...
                . 'gerarRelatorio(chave, relatorioMenor72);'
                . '$("#modal").modal(\'show\'); }',
            ),
        )
        ),
        'series' => array(
            array(
                ...
                'name' => 'Quantidade: ',
                'data' => $model->graficoPorTipo('nmServico', 'menor'),
            ),
        ),
        )));?>

<?php
    $dados = $model->graficoPorTipo('nmServico', 'relatorioMenor72');
    $dados = json_encode( $dados );
?>

<script type="text/javascript">
    var relatorioMenor72 = <?php echo $dados ?>;
</script>