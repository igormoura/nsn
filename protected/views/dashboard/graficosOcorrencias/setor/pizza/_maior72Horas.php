    ...
    'options' => array(
        ...
        'pie' => array(
            ...
            'events' => array(
                ...
                . 'gerarRelatorio(chave, relatorioSetorMaior72);'
                . '$("#modal").modal(\'show\'); }',
            ),
        )
        ),
        'series' => array(
            array(
                ...
                'name' => 'Quantidade ',
                'data' => $model->dashboardOcorrencias('ds_setor','maior'),
            ),
        ),
      ),
...
<?php
    $dados = $model->dashboardOcorrencias('ds_setor','relatorioMaior72');
    $dados = json_encode( $dados );
?>

<script type="text/javascript">
    var relatorioSetorMaior72 = <?php echo $dados ?>;
</script>