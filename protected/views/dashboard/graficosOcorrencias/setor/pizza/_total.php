    ...
    'options' => array(
        ...
        'plotOptions' => array(
            'pie' => array(
                ...
                'events' => array(
                    ...
                    . 'gerarRelatorio(chave, relatorioSetorTotal);'
                    . '$("#modal").modal(\'show\'); }',
                ),
            ),
        ),
        'series' => array(
            array(
                ...
                'name' => 'Quantidade ',
                'data' => $model->dashboardOcorrencias('ds_setor','total'),
            ),
        ),
      ),
...
<?php
    $dados = $model->dashboardOcorrencias('ds_setor','relatorioTotal');
    $dados = json_encode( $dados );
?>

<script type="text/javascript">
    var relatorioSetorTotal = <?php echo $dados ?>;
