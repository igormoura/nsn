...
$this->Widget('ext.highcharts.HighchartsWidget', array(
    'options' => array(
        ...
        'title' => array(
        'text' => Yii::t('main','dashboard.ocorrencias.tipoServicoMaior72').'<br><br>'.$model->dataGrafico
        ),
        'tooltip' => array(
        ...
        'pie' => array(
            ...
            'events' => array(
                ...
                . 'gerarRelatorio(chave, relatorioProblemaMaior72);'
                . '$("#modal").modal(\'show\'); }',
            ),
        )
        ),
        'series' => array(
            array(
                ...
                'name' => 'Quantidade ',
                'data' => $model->dashboardOcorrencias('dsProblema','maior'),
            ),
        ),
      ),
...
<?php
    $dados = $model->dashboardOcorrencias('dsProblema','relatorioMaior72');
    $dados = json_encode( $dados );
?>

<script type="text/javascript">
    var relatorioProblemaMaior72 = <?php echo $dados ?>;
</script>