...
$this->Widget('ext.highcharts.HighchartsWidget', array(
    'options' => array(
        ...
        'title' => array(
            'text' => "Vendas por Cursos".'<br><br>'.$model->dataGrafico
        ),
        'tooltip' => array(
        ...
        'plotOptions' => array(
            'pie' => array(
                ...
                'events' => array(
                    ...
                    . 'gerarRelatorio(chave, relatorioCursosTurmas);'
                    . '$("#modal").modal(\'show\'); }',
                ),
            )
        ),
...
<?php
    $dados = $model->dashboardVendas('cursos','relatorio');
    $dados = json_encode($dados);
?>

<script type="text/javascript">
    var relatorioCursosTurmas = <?php echo $dados ?>;
</script>
