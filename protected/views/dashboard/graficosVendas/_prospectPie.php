...
$this->Widget('ext.highcharts.HighchartsWidget', array(
    'options' => array(
        ...
        'title' => array(
           'text' => "Vendas por Clientes".'<br><br>'.$model->dataGrafico
        ),
        'tooltip' => array(
        ...
        'plotOptions' => array(
            'pie' => array(
                ...
                'events' => array(
                    ...
                    . 'gerarRelatorio(chave, relatorioCliente);'
                    . '$("#modal").modal(\'show\'); }',
                ),
            )
        ),
        'series' => array(
            array(
                ...
                'name' => 'Valor: R$ ',
                'data' => $model->dashboardVendas('prospect','prospect'),
            ),
        ),
      ),
...
<?php
    $dados = $model->dashboardVendas('prospect','relatorio');
    $dados = json_encode($dados);
?>

<script type="text/javascript">
    var relatorioCliente = <?php echo $dados ?>;
</script>