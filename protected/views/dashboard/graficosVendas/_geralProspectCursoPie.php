...
$this->Widget('ext.highcharts.HighchartsWidget', array(
    'options' => array(
        ...
        'title' => array(
            'text' => "Vendas por tipos de Alunos".'<br><br>'.$model->dataGrafico
        ),
        'tooltip' => array(
        ...
        'plotOptions' => array(
            'pie' => array(
                ...
                'events' => array(
                    ...
                    . 'gerarRelatorio(chave, relatorioTotalAluno);'
                    . '$("#modal").modal(\'show\'); }',
                ),
            )
        ),
        'series' => array(
            array(
               ...
               'name' => 'Valor: R$ ',
                'data' => $model->dashboardVendas('tipoAluno','geralProspectCursos'),
            ),
        ),
      ),
...
<?php
    $dados = $model->dashboardVendas('tipoAluno','relatorio');
    $dados = json_encode($dados);
?>

<script type="text/javascript">
    var relatorioTotalAluno = <?php echo $dados ?>;
</script>