	...
	'columns'=>array(
		...
		array(
			...
			//'viewButtonImageUrl'=>"{$module->baseScriptUrl}/images/authItemView.png",
                        'buttons'=>array('view'=>array('icon' => 'zoom-in'))
		),
		array(
		...
		array(
			...
			'visible'=>Yii::app()->user->checkAccess($module->authItemsManagerRole),
                        'buttons'=>array('update'=>array('icon' => 'wrench'))      
		...
		array(
			...
			'headerHtmlOptions'=>array('scope'=>'col'),
			'footer'=>CHtml::link(CHtml::image(Yii::t('RbamModule.rbam','Assign Role(s)')), array('assign','uid'=>$user->{$module->userIdAttribute}), array('class'=>'add icon-plus-sign button-footer-table-rbam', 'title'=>Yii::t('RbamModule.rbam','Assign role(s) to this user'))),
