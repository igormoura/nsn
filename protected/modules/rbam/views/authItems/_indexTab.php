...
$this->widget('rbam.extensions.alphapager.ApGridView', array(
	...
	'columns'=>array(
		...
		array(
			...
			'headerHtmlOptions'=>array('scope'=>'col'),
			'footer'=>CHtml::link(CHtml::image(Yii::t('RbamModule.rbam','Create {type}', array('{type}'=>$this->type($type, true, true)))), array('create', 'type'=>$type), array('class'=>'add icon-plus-sign button-footer-table-rbam','title'=>Yii::t('RbamModule.rbam','Create {type}', array('{type}'=>$this->type($type, true, true))))),
