...
class Ocorrencia extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'dt_hr_ini_atendimento' =>  Yii::t('main','dt_hr_ini_atendimento'),
			'dt_hr_fim_atendimento' =>  Yii::t('main','dt_hr_fim_atendimento'),
			'id_usuario' =>				Yii::t('main','id_usuario'),
			'id_setor' => 				Yii::t('main','id_setor'),
			'OrigemdaOcorrencia' => 	Yii::t('main','OrigemdaOcorrencia'),
			'id_grupo' => 				Yii::t('main','id_grupo'),
			'OrigemEmail' => 			Yii::t('main','OrigemEmail'),
			'idUsuarioF' => 			Yii::t('main','idUsuarioF'),
			'flagVisivelCliente' => 	Yii::t('main','flagVisivelCliente'),
			'flagSolicitacao' =>		Yii::t('main','flagSolicitacao'),
		);
	}
