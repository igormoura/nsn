...
class YiiLogController extends RController
{
	/**
	 ...
	 * @param YiiLog $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
        ...
        {
            // partially rendering "_detailsDuplicatas" view
            $this->renderPartial('_detailsYiiLog', array(
